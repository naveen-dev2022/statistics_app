    ...
    return Row(
      ...
      children: [
            ...
            child: SfCircularChart(
                ...
                series: <CircularSeries<ChartData, String>>[
                  DoughnutSeries<ChartData, String>(
                    startAngle: 0,
                    endAngle: 360,
                    dataSource: expensesController.donutChartData!,
        ...
        Column(
          ...
          children: [
            for (int i = 0; i < expensesController.donutChartData!.length; i++)
              Column(
                children: [
                  Row(
                    children: [
                      ...
                      AppWidgets.buildText(
                          ...
                          text:
                              '${((expensesController.donutChartData![i].y / expensesController.categoryTotalAmount) * 100).truncate()}% ${expensesController.donutChartData![i].x}'),
                    ],
                  ),
                  SizedBox(
                    height: 15,
